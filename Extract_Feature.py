...
os.system("../../anaconda3/bin/python count_base_v1.py")
os.system("../../anaconda3/bin/python features_predict.py "+str1+" "+str2+" "+str5)
os.system("../../anaconda3/bin/python features_predict.py "+str3+' '+str4+" "+str6)
os.system("../../anaconda3/bin/python Dataset_Generator.py")
